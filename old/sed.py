...
from old import metrics, config
import utils
...
def _get_available_gpus():
    ...
    # Returns
        A list of availabl e GPU devices.
    """
...
is_mono = config.is_mono  # True: mono-channel input, False: binaural input
...
avg_er = list()
avg_f1 = list()
for fold in range(config.folds - 1):
    print('\n\n----------------------------------------------')
